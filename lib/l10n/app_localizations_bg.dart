...
class AppLocalizationsBg extends AppLocalizations {
  ...
  String get privacyPolicyLocalStorageBody =>
      'Данните за графика и свързаните с тях настройки се съхраняват в локален файл на име KeSchedule_data.json в директорията документи на приложението. Редактируемата конфигурация на училището се съхранява отделно в KeSchedule_school_sites.json. Персонализираните настройки на анализатора на графика, включително всеки персонализиран базов URL адрес, API ключ и избран модел, също се съхраняват локално в същите данни на приложението и не са защитени от трезор за системни данни. Когато се използват в браузър, същите видове данни се съхраняват в съхранението на браузъра. Приложението не качва автоматично тези локални данни на сървър, контролиран от разработчика.';
