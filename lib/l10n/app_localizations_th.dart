...
class AppLocalizationsTh extends AppLocalizations {
  ...
  String get privacyPolicyLocalStorageBody =>
      'ข้อมูลตารางและการตั้งค่าที่เกี่ยวข้องจะถูกเก็บไว้ในไฟล์ท้องถิ่นที่ชื่อ KeSchedule_data.json ภายในไดเรคเตอรี่เอกสารแอป การตั้งค่าเว็บไซต์โรงเรียนที่แก้ไขได้ถูกเก็บไว้แยกต่างหากใน KeSchedule_school_sites.json การตั้งค่าเครื่องวิเคราะห์ตารางเวลาที่กำหนดเอง รวมถึง URL ฐาน, คีย์ API และรุ่นที่เลือกที่กำหนดเอง ยังจะถูกเก็บไว้ในท้องถิ่นในข้อมูลแอพเดียวกันและไม่ได้รับการค เมื่อใช้ในเบราว์เซอร์ ข้อมูลประเภทเดียวกันจะถูกเก็บไว้ในที่เก็บเบราว์เซอร์ แอพไม่อัพโหลดข้อมูลท้องถิ่นนี้ไปยังเซิร์ฟเวอร์ที่ควบคุมโดยนักพัฒนาโดยอัตโนมัติ';
  ...
  String get privacyPolicyNoCollectionBody =>
      'แอพไม่ต้องใช้บัญชี KeSchedule และไม่เปิดใช้งานการวิเคราะห์ ตัวระบุการโฆษณา หรือการสำรองข้อมูลในเมฆ นอกจากนี้ยังไม่ให้สนามที่เฉพาะสำหรับการเก็บรวบรหัสผ่านบัญชีโรงเรียน ถ้าคุณเข้าสู่เว็บไซต์โรงเรียนภายในแอป การปฏิสัมพันธ์นั้นเกิดขึ้นในหน้าโรงเรียนที่คุณเปิด';
